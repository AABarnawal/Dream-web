  ...
  return (
    <>
      ...
      <div
        ...
        style={{ contentVisibility: "auto", containIntrinsicSize: "800px" }} // Faster Rendering
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Your trusted partner in cybersecurity and IT solutions since
              2009. We leverage cutting-edge technology to protect and empower
